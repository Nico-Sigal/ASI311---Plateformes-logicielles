...
public class JdbcFilmDAO implements FilmDAO {
      ...
      private static final String FIND_ALL_FILMS_WITH_REAL_QUERY =
      "SELECT * FROM Film LEFT JOIN Realisateur ON Film.realisateur_id=Realisateur.id";
      private static final String FIND_FILM_BY_ID_WITH_REAL = "SELECT * FROM Film LEFT JOIN Realisateur ON Film.realisateur_id=Realisateur.id WHERE Film.id=?";
      private static final String FIND_FILMS_BY_REAL_ID = "SELECT * FROM Film WHERE realisateur_id=?";
      @Override
      public List<Film> findAll() {
      List<Film> liste = jdbcTemplate.query(FIND_ALL_FILMS_WITH_REAL_QUERY, (rs, rownum) -> {
      Film f = new Film();
